...
The recommended workflow is simple: create one folder per keyboard, keycap set, or combination; put an `index.md` in it; then drop the related photos beside the Markdown file.
